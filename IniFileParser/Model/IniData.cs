...
namespace IniParser.Model
{
    ...
    public class IniData : ICloneable
    {
        ...
        public bool TryGetKeyData(string key, out KeyData value)
        {
            value = null;
            if (string.IsNullOrEmpty(key))
                return false;
            ...
            value = sectionData.GetKeyData(key);
            return true;
        }
        ...
        {
            KeyData result;
            return TryGetKeyData(key, out result) ? result : null;
        }
