namespace System.UI.Widget
{
	partial class FrmToast
	{
		...
		private void InitializeComponent()
		{
			...
			this.loadingDotsProgress1 = new System.UI.Progress.LoadingDotsProgress();
			...
			this.picImage.VisibleChanged += new System.EventHandler(this.MyForm_VisibleChanged);
			...
			this.textContainer.Panel2.Controls.Add(this.loadingDotsProgress1);
			...
			this.lblCaption.Location = new System.Drawing.Point(5, 2);
			...
			this.picAppOwnerIcon.Location = new System.Drawing.Point(267, 64);
			...
			this.lblDescription.Size = new System.Drawing.Size(292, 61);
    ...
    "el diam.";
			...
			// 
			// loadingDotsProgress1
			// 
			this.loadingDotsProgress1.AnimationSpeed = 150;
			this.loadingDotsProgress1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(30)))), ((int)(((byte)(30)))), ((int)(((byte)(30)))));
			this.loadingDotsProgress1.Direction = System.UI.Progress.AnimationDirection.LeftToRight;
			this.loadingDotsProgress1.DotCount = 10;
			this.loadingDotsProgress1.Location = new System.Drawing.Point(8, 53);
			this.loadingDotsProgress1.Name = "loadingDotsProgress1";
			this.loadingDotsProgress1.Size = new System.Drawing.Size(253, 23);
			this.loadingDotsProgress1.TabIndex = 3;
			this.loadingDotsProgress1.Text = "loadingDotsProgress1";
			// 
			// FrmToast
			// 
		...
		public Windows.Forms.PictureBox picAppOwnerIcon;
		private Progress.LoadingDotsProgress loadingDotsProgress1;
	}
}