...
namespace E3NextUI.Util
{
	...
	class globalKeyboardHook
	{
		...
		#endregion
		uint _parentProcess = 0;

		#region Constructors and Destructors
		/// <summary>
		/// Initializes a new instance of the <see cref="globalKeyboardHook"/> class and installs the keyboard hook.
		/// </summary>
		public globalKeyboardHook(uint parentProcess)
		{
		...
		public void hook()
		{
			...
			//note, had to fix this as it was passing the method strait down to unmanaged code which is a big no-no.
			//Rekka
			_functionProc = new keyboardHookProc(hookProc);

			hhook = SetWindowsHookEx(WH_KEYBOARD_LL, _functionProc, hInstance, 0);
		}
		...
		public int hookProc(int code, int wParam, ref keyboardHookStruct lParam)
		{
			if (code >= 0)
			{
				...
				if (pid == _parentProcess) //not our parent process, ignore this
				{
