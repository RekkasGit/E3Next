    ...
    public static class InventoryDataCollector
    {
        ...
        private static void CaptureAugments(IMQ mq, string itemTloPrefix, InventoryItem target)
        {
            ...
            for (int a = 1; a <= 6; a++)
            {
                ...
                int augStr = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.STR{suffix}");
                int augSta = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.STA{suffix}");
                int augAgi = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.AGI{suffix}");
                int augDex = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.DEX{suffix}");
                int augWis = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.WIS{suffix}");
                int augInt = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.INT{suffix}");
                int augCha = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.CHA{suffix}");
                int augHeroicStr = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicSTR{suffix}");
                int augHeroicSta = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicSTA{suffix}");
                int augHeroicAgi = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicAGI{suffix}");
                int augHeroicDex = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicDEX{suffix}");
                int augHeroicWis = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicWIS{suffix}");
                int augHeroicInt = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicINT{suffix}");
                int augHeroicCha = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicCHA{suffix}");
                int augSvMagic = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.svMagic{suffix}");
                int augSvFire = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.svFire{suffix}");
                int augSvCold = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.svCold{suffix}");
                int augSvDisease = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.svDisease{suffix}");
                int augSvPoison = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.svPoison{suffix}");
                int augSvCorruption = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.svCorruption{suffix}");
                int augHeroicSvMagic = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicSvMagic{suffix}");
                int augHeroicSvFire = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicSvFire{suffix}");
                int augHeroicSvCold = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicSvCold{suffix}");
                int augHeroicSvDisease = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicSvDisease{suffix}");
                int augHeroicSvPoison = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicSvPoison{suffix}");
                int augHeroicSvCorruption = SafeQueryInt(mq, $"{prefix}.AugSlot[{a}].Item.HeroicSvCorruption{suffix}");
                ...
                target.Augs.Add(new InventoryAugment
                {
                    ...
                    Intel = augInt,
                    Cha = augCha,
                    HeroicStr = augHeroicStr,
                    HeroicSta = augHeroicSta,
                    HeroicAgi = augHeroicAgi,
                    HeroicDex = augHeroicDex,
                    HeroicWis = augHeroicWis,
                    HeroicInt = augHeroicInt,
                    HeroicCha = augHeroicCha,
                    SvMagic = augSvMagic,
                    SvFire = augSvFire,
                    SvCold = augSvCold,
                    SvDisease = augSvDisease,
                    SvPoison = augSvPoison,
                    SvCorruption = augSvCorruption,
                    HeroicSvMagic = augHeroicSvMagic,
                    HeroicSvFire = augHeroicSvFire,
                    HeroicSvCold = augHeroicSvCold,
                    HeroicSvDisease = augHeroicSvDisease,
                    HeroicSvPoison = augHeroicSvPoison,
                    HeroicSvCorruption = augHeroicSvCorruption,
                    AugType = augType
                });
            }
        }
        ...
        private static void CaptureStats(IMQ mq, string basePath, InventoryItem item)
        {
            ...
            item.HeroicStr = SafeQueryInt(mq, $"{prefix}.HeroicSTR{suffix}");
            item.HeroicSta = SafeQueryInt(mq, $"{prefix}.HeroicSTA{suffix}");
            item.HeroicAgi = SafeQueryInt(mq, $"{prefix}.HeroicAGI{suffix}");
            item.HeroicDex = SafeQueryInt(mq, $"{prefix}.HeroicDEX{suffix}");
            item.HeroicWis = SafeQueryInt(mq, $"{prefix}.HeroicWIS{suffix}");
            item.HeroicInt = SafeQueryInt(mq, $"{prefix}.HeroicINT{suffix}");
            item.HeroicCha = SafeQueryInt(mq, $"{prefix}.HeroicCHA{suffix}");
            item.SvMagic = SafeQueryInt(mq, $"{prefix}.svMagic{suffix}");
            item.SvFire = SafeQueryInt(mq, $"{prefix}.svFire{suffix}");
            item.SvCold = SafeQueryInt(mq, $"{prefix}.svCold{suffix}");
            item.SvDisease = SafeQueryInt(mq, $"{prefix}.svDisease{suffix}");
            item.SvPoison = SafeQueryInt(mq, $"{prefix}.svPoison{suffix}");
            item.SvCorruption = SafeQueryInt(mq, $"{prefix}.svCorruption{suffix}");
            item.HeroicSvMagic = SafeQueryInt(mq, $"{prefix}.HeroicSvMagic{suffix}");
            item.HeroicSvFire = SafeQueryInt(mq, $"{prefix}.HeroicSvFire{suffix}");
            item.HeroicSvCold = SafeQueryInt(mq, $"{prefix}.HeroicSvCold{suffix}");
            item.HeroicSvDisease = SafeQueryInt(mq, $"{prefix}.HeroicSvDisease{suffix}");
            item.HeroicSvPoison = SafeQueryInt(mq, $"{prefix}.HeroicSvPoison{suffix}");
            item.HeroicSvCorruption = SafeQueryInt(mq, $"{prefix}.HeroicSvCorruption{suffix}");
